...
After the vehicle classes are done, students should write a Customer class that stores
    a name and
    a rental history,
...
Students should also write write a RentalCompany class that
...
Finally, students should write a test class that
